...
var neutral = preload("res://art/portraits/noir.png")
var sad = preload("res://art/portraits/noir_sad.png")
var happy = preload("res://art/portraits/noir_happy.png")
...
func nextPhrase() -> void:
	...
	match (dialog[phraseNum]["Emotion"]):
		...
		"Happy":
			$Background/Character.texture = happy
